...
// const UpdationBox: React.FC<UpdationBoxProps> = ({
//   BoxState,
//   BoxStateChange,
//   editPackage,
//   onSuccess,
...
//   useEffect(() => {
//     if (editPackage) {
//       setPackageName(editPackage.package_name || "");
//       setPackageDescription(editPackage.package_description || "");
//       setPackageCategoryId(editPackage.tnp_destinations?.destination_category_id?.toString() || "");
//       setPackageTypeId(editPackage.tnp_package_types?.package_type_id?.toString() || "");
//       setPackageRegionId(editPackage.tnp_destinations?.destination_region_id?.toString() || "");
//       setPackageDuration(editPackage.package_duration?.toString() || "");
//       setPackageRateNormal(editPackage.package_rate_normal?.toString() || "");
//       setPackageRateDeluxe(editPackage.package_rate_deluxe?.toString() || "");
//       setPackageTotalPersons(editPackage.package_total_persons?.toString() || "");
      
//       if (editPackage.package_details) {
//         try {
//           const details = JSON.parse(editPackage.package_details);
//           setTableData(details.TripDetailsAndCostSummary?.Itinerary || []);
...
//     const updatedCostExcludes = [...costExcludes];
//     updatedCostExcludes.splice(index, 1);
...
//     formData.append("package_id", editPackage.package_id.toString());
